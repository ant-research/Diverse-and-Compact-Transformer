    ...
    if 'triplet' in cfg.DATALOADER.SAMPLER:
        if cfg.MODEL.DIST_TRAIN:
            ...
            if cfg.MODEL.ID_HARD_MINING:
                data_sampler = RandomIdentityBatchSampler_DDP(dataset.train, cfg.SOLVER.IMS_PER_BATCH, cfg.DATALOADER.NUM_INSTANCE, num_classes)
            else:
            ...
            if cfg.MODEL.ID_HARD_MINING:
                train_loader = DataLoader(
                    ...
                    sampler=RandomIdentityBatchSampler(dataset.train, cfg.SOLVER.IMS_PER_BATCH, cfg.DATALOADER.NUM_INSTANCE, num_classes),
